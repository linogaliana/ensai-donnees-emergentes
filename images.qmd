...
où $\star$ est l'opérateur de convolution 2-dimensionnel en traitement du signal (illustré en Figure~\ref{fig:convol}). Alors l'image $G = \sqrt{G_x^2 + G_y^2}$ est une représentation des contours de l'image $A$.
...
\subsection{Application : extraction d'informations de documents scannés photographiés}
