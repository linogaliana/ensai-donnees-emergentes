...
le cadre d'activités économiques qui n'ont
pas lieu avec l'administration.
...
Une fois payé le coût d'investtisement pour automatiser la production statistique
...
n'est possible qu'avec un nombre restreint d'enquêtes, dont
les résultats peuvent être connus avec retard. 
...
que l'analyste de donnée n'ait son mot à dire.
...
de gestion la réalité statistique derrière [@salgado]. Le travail
